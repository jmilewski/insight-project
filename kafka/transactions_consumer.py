...
consumer = KafkaConsumer('node-transactions-test2', group_id='test-group', bootstrap_servers=['10.0.0.14:9092'])
...
for message in consumer:
    if message.value:
        try:
            ...
            cur.execute("INSERT INTO transactions_test VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", values)
            conn.commit()
